package com.club_vibe.app_be.unit.users.auth;
...
class AuthServiceTest {
    ...
    void registerClubSuccess() {
        // Arrange
        RegisterRequest request = new RegisterRequest(TEST_EMAIL, TEST_PASSWORD, TEST_NAME, StaffRole.CLUB, Country.BG);
    ...
    void registerArtistSuccess() {
        // Arrange
        RegisterRequest request = new RegisterRequest(TEST_EMAIL, TEST_PASSWORD, TEST_NAME, StaffRole.ARTIST, Country.BG);
